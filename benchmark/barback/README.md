...
request-phone-number consent message through Signal and verify its decrypted
protobuf in Barback's bounded capture buffer. This uses only the synthetic
browser and fake phone identities.
